...
var description = "T7 has been ever so slightly changed. Let's see how OP it becomes. ";
var authors = "Gilles-Philippe Paillé (edit by invalid-user)";
var version = 2;
...
var init = () => {
    ...
    // q1
    {
        ...
        q1 = theory.createUpgrade(0, currency1, new FirstFreeCost(new ExponentialCost(400, Math.log2(1.41572))));
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(1, currency1, new ExponentialCost(8, Math.log2(1.175)));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(2, currency1, new ExponentialCost(30, Math.log2(7)));
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(3, currency1, new ExponentialCost(1e4, Math.log2(50)));
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(4, currency1, new ExponentialCost(8, Math.log2(2.5)));
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(5, currency1, new ExponentialCost(1e7, Math.log2(40)));
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(6, currency1, new ExponentialCost(6.9e1, Math.log2(2.51)));
    ...
    /////////////////////
    // Permanent Upgrades
    theory.createPublicationUpgrade(0, currency1, 1e8);
    theory.createBuyAllUpgrade(1, currency1, 1e10);
    theory.createAutoBuyerUpgrade(2, currency1, 1e17);

    //////////////////////
    // Checkpoint Upgrades
    theory.setMilestoneCost(new LinearCost(23, 22));
...
var getPublicationMultiplier = (tau) => tau.pow(0.162);
var getPublicationMultiplierFormula = (symbol) => "{" + symbol + "}^{0.162}";
