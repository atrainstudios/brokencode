...
var id = "recurrence_relations";

var name = "Recurrence Relation_BROKEN";

var description = "An implementation of the 'Recurrence Relation' theory from the game.";

var authors = "Johnny Appleseed";
...
var init = () => {
...

    {
        ...
        q1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(3, Math.log2(1.3))));
...

    {
        ...
        q2 = theory.createUpgrade(1, currency, new ExponentialCost(10, Math.log2(3)));
...

    {
        ...
        c1 = theory.createUpgrade(2, currency, new ExponentialCost(1, Math.log2(1.5)));
...

    {
        ...
        c1Exp = theory.createMilestoneUpgrade(0, 12);
...

    {
        ...
        logTerm = theory.createMilestoneUpgrade(1, 12);
...

    {
        ...
        c3Term = theory.createMilestoneUpgrade(2, 12);
...

    {
        ...
        c4Term = theory.createMilestoneUpgrade(3, 12);
