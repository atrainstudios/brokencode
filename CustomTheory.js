...
var tick = (elapsedTime, multiplier) => {
    ...
    currency.value += dt * bonus * getC1(getC1(c1.level)).pow(getC1Exponent(c1Exp.level)) *
                                   getC2(getC2(c2.level)).pow(getC2Exponent(c2Exp.level));
}
...
var getC2 = (level) => BigNumber.FOUR.pow(level);
